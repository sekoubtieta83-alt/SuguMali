    ...
    <Card className="w-full max-w-md shadow-2xl rounded-3xl border-none">
      ...
      <CardContent className="grid gap-6 px-8 pb-10">
        ...
        <div className="grid grid-cols-1">
          <Button variant="outline" className="h-[55px] rounded-xl border-border font-semibold text-base bg-white text-black hover:bg-accent/10 hover:text-accent hover:border-accent flex items-center justify-center gap-3 transition-all" onClick={handleGoogleSignIn} disabled={isLoading}>
